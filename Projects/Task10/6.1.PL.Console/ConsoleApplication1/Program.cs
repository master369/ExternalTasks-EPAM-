...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        private static IRelationBLL relationLogic;
        ...
        private static void CreateNewAward()
        {
            ...
            try
            {
                ...
                Console.WriteLine((awardsLogic.Create(award)) ?
                                    "Награда добавлена!" :
        ...
        private static void AddAwardToUser()
        {
            ...
            try
            {
                ...
                if (relationLogic.Create(userId, awardId))
        ...
        private static void CreateNewUser()
        {
            ...
            try
            {
                ...
                Console.WriteLine((usersLogic.Create(user)) ?
